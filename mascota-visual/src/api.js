...
export const getNotifications = async (token, limit = 20, offset = 0) => {
  const res = await axios.get(`${API_URL}/notifications?limit=${limit}&offset=${offset}`, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};
...
export const markNotificationAsRead = async (notificationId, token) => {
  const res = await axios.post(`${API_URL}/notifications/${notificationId}/read`, {}, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};
...
export const markAllNotificationsAsRead = async (token) => {
  const res = await axios.post(`${API_URL}/notifications/read-all`, {}, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};
...
// Funciones de logros secretos
export const getSecretAchievements = async (token) => {
  const res = await axios.get(`${API_URL}/secret-achievements`, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};

export const checkSecretTrigger = async (trigger, data, token) => {
  const res = await axios.post(`${API_URL}/secret-achievements/trigger`, { trigger, data }, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};

export const activateEasterEgg = async (eggId, data, token) => {
  const res = await axios.post(`${API_URL}/secret-achievements/easter-egg`, { eggId, data }, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};

export const getEasterEggStats = async (token) => {
  const res = await axios.get(`${API_URL}/secret-achievements/easter-egg/stats`, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};

export const generateRandomEasterEgg = async (token) => {
  const res = await axios.post(`${API_URL}/secret-achievements/easter-egg/random`, {}, {
    headers: { Authorization: `Bearer ${token}` }
  });
  return res.data;
};
